...
class GraphQLBodyComponent(val store: GraphQLStore) : JPanel() {
    ...
    private val topScrollPane = JBScrollPane(JPanel().apply {
        ...
        add(JPanel().apply {
            ...
            val virtualFile =
                LightVirtualFile("temp.graphql", PlainTextLanguage.INSTANCE, store.graphQLState.getState().query)
    ...
    private val bottomScrollPane = JBScrollPane(JPanel().apply {
        ...
        add(JPanel().apply {
            ...
            val virtualFile =
                LightVirtualFile("temp.json", TJsonLanguage.INSTANCE, store.graphQLState.getState().variable)
