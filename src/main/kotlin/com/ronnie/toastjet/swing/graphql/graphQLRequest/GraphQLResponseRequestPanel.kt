...
import com.ronnie.toastjet.swing.graphql.graphQLResponse.GraphQLResReqBodyPanel
...
class GraphQLResponseRequestPanel (
    ...
    fun populatePanel() {
        val sendRequest = response.getState().apiRequestData
        ...
        if (paramsData.isEmpty()) {
            ...
            radioTabbedPanel.addTab("Params", ConstructResReqBody(headersData, theme))
        }
