...
class DescriptionPanel(store: ConfigStore) : JPanel(BorderLayout()) {
    init {
        val js = Language.findLanguageByID("Markdown") ?: PlainTextLanguage.INSTANCE
            ...
            object : DocumentListener {
                override fun documentChanged(event: DocumentEvent) {
                    store.state.setState {
                        it.description = event.document.text
                        it
                    }
                }
            })
