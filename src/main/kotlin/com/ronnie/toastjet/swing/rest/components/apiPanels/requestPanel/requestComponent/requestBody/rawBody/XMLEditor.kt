...
class XMLEditor(data: StateHolder<String>,appStore: AppStore) : JPanel(BorderLayout()) {
    ...
    init {
        ...
        val virtualFile = LightVirtualFile("temp.json", XmlFileType.INSTANCE, data.getState())
