...
class MarkdownEditor (data: StateHolder<String>,appStore: AppStore) : JPanel(BorderLayout()) {
    ...
    init {
        ...
        val virtualFile = LightVirtualFile("temp.json",  Language.findLanguageByID("Markdown") ?: PlainTextLanguage.INSTANCE, data.getState())
