...
import SimpleInputSuggestions from "../Input/SimpleInputSuggestion";
import DocumentedInput from "../Input/DocumentedInput";
  ...
  return (
    ...
    >
      <BarInputSuggestions
        ...
        // inputValue={requestData.data.name}
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        ...
        <button
          ...
          onMouseLeave={(e) =>
            (e.currentTarget.style.color = theme.primaryContainer)
          }
        >
          {isCodeView ? <FaCode /> : <FaDesktop />}
        </button>
      </div>
    </div>
  );
